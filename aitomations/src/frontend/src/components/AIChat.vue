        ...
        <div v-if="response" class="ai-response-container mb-4 pa-3" :class="responseContainerClass">
            ...
            <template v-if="!response.error">
                ...
                <div v-if="response.automation_yaml" class="mt-4">
                    <v-btn color="success" variant="elevated" @click="handleInstallAutomation">
...
// Initialize HA theme (this will inject the CSS variables)
...
<style scoped>
/* Minimal component-specific styles - most styling comes from global ha-theme.css */
.ai-response-header {
    display: flex;
    align-items: center;
    font-size: 1.1rem;
